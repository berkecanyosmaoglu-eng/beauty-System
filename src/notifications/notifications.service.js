...
var NotificationsService = function () {
    ...
    var NotificationsService = _classThis = /** @class */ (function () {
        function NotificationsService_1(sms) {
            this.sms = sms;
            this.logger = new common_1.Logger(NotificationsService.name);
        }
        NotificationsService_1.prototype.sendBookingConfirmation = function (args) {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            startText = args.startAt.toLocaleString('tr-TR', {
                                dateStyle: 'medium',
                                timeStyle: 'short',
                            });
                            msg = "\u2705 ".concat(args.salonName, "\n") +
                                "Randevunuz olu\u015Fturuldu.\n" +
                                "\u0130\u015Flem: ".concat(args.serviceName, "\n") +
                                (args.staffName ? "Uzman: ".concat(args.staffName, "\n") : '') +
                                "Tarih/Saat: ".concat(startText, "\n") +
                                (args.addressShort ? "Adres: ".concat(args.addressShort, "\n") : '') +
                                "De\u011Fi\u015Fiklik i\u00E7in bu numaraya yazabilirsiniz.";
                            return [4 /*yield*/, this.sms.sendSms(args.toPhone, msg)];
                        case 1:
                            _a.sent();
                            return [2 /*return*/];
                    }
