...
var StaffController = function () {
    var _classDecorators = [(0, common_1.Controller)('staff')];
    ...
    var StaffController = _classThis = /** @class */ (function () {
        ...
        StaffController_1.prototype.create = function (dto) {
            return this.staffService.create(dto);
        };
        StaffController_1.prototype.findAll = function (tenantId) {
            return this.staffService.findAll(tenantId);
        };
        StaffController_1.prototype.findOne = function (id) {
            return this.staffService.findOne(id);
        };
        StaffController_1.prototype.update = function (id, dto) {
            return this.staffService.update(id, dto);
        };
        StaffController_1.prototype.remove = function (id) {
