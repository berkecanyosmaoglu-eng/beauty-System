...
var SmsService = function () {
    ...
    var SmsService = _classThis = /** @class */ (function () {
        function SmsService_1() {
            ...
            this.from = process.env.TWILIO_SMS_FROM || ''; // ✅ sende bu var
            this.client = null;
        }
        SmsService_1.prototype.getClient = function () {
            if (!this.client) {
        ...
        SmsService_1.prototype.normalizePhone = function (input) {
            if (!input)
                return null;
            var p = String(input).trim().replace(/[()\-\s]/g, '');
            if (p.startsWith('+'))
                return p;
            // TR: 05xxxxxxxxx -> +905xxxxxxxxx
            if (p.startsWith('0') && p.length === 11 && p.startsWith('05'))
                return "+9".concat(p);
        ...
        SmsService_1.prototype.sendSms = function (toRaw, body) {
            return __awaiter(this, void 0, void 0, function () {
                var to, client, res, e_1;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            _a.trys.push([1, 3, , 4]);
                            return [4 /*yield*/, client.messages.create({ from: this.from, to: to, body: body })];
                        case 2:
                            res = _a.sent();
                            this.logger.log("SMS sent to=".concat(to, " sid=").concat(res.sid));
                            return [3 /*break*/, 4];
                        case 3:
                            e_1 = _a.sent();
                            this.logger.error("SMS send failed to=".concat(to, ": ").concat((e_1 === null || e_1 === void 0 ? void 0 : e_1.message) || e_1));
                            return [3 /*break*/, 4];
