...
var AppController = function () {
    ...
    var AppController = _classThis = /** @class */ (function () {
        ...
        // Admin panel için metrikler
        // tenantId zorunlu (multi-tenant)
        AppController_1.prototype.metrics = function (tenantId) {
            return __awaiter(this, void 0, void 0, function () {
                var todayStart, todayEnd, _a, tenantCount, todayAppointments, whatsappCount, jarvisMinutes;
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            if (!tenantId) {
                                return [2 /*return*/, { ok: false, error: 'tenantId gerekli' }];
                            }
                            todayStart = new Date();
                            ...
                            return [4 /*yield*/, Promise.all([
                                    ...
                                    // ✅ WhatsApp mesaj sayısı: BotMessage üzerinden say
                        ...
                        case 1:
                            _a = _b.sent(), tenantCount = _a[0], todayAppointments = _a[1], whatsappCount = _a[2];
                            jarvisMinutes = 0;
                            return [2 /*return*/, {
                                    ok: true,
    ...
    (function () {
        ...
        _metrics_decorators = [(0, common_1.Get)('admin/metrics')];
        ...
        __esDecorate(_classThis, null, _metrics_decorators, { kind: "method", name: "metrics", static: false, private: false, access: { has: function (obj) { return "metrics" in obj; }, get: function (obj) { return obj.metrics; } }, metadata: _metadata }, null, _instanceExtraInitializers);
