...
var TenantController = function () {
    var _classDecorators = [(0, common_1.Controller)("tenants")];
    ...
    var TenantController = _classThis = /** @class */ (function () {
        function TenantController_1(tenantService) {
            this.tenantService = (__runInitializers(this, _instanceExtraInitializers), tenantService);
        }
        TenantController_1.prototype.create = function (body) {
            return this.tenantService.create(body.name);
        };
        TenantController_1.prototype.list = function () {
